...
public class DDPyjama {
    ...
    public static void main(String[] args) {
		...
		//Pyjama.omp_set_schedule(OmpScheduleClause.Dynamic);
        //#omp parallel for num_threads(numThreads) shared(numLigands, ligands, ligandsWScore, protein) reduction(max:maxScore) schedule(static)
        for(int i = 0; i < numLigands; i++) {
